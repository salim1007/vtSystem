<div class="flex flex-col w-full text-sm h-full">
    <div class="flex h-14 items-center p-3 shadow-lg justify-between bg-gray-300 w-full">
        <span class="flex font-bold">Candidates List</span>
    ...
    <div class="flex w-full flex-col mt-2 bg-gray-200 h-full">
        <div class="p-3">
            <input wire:model.live.debounce.200ms="search" type="search" id="search" name="search" class="flex p-2 rounded-xl w-64 h-10 text-xs" placeholder="Search by: name, reg_number" />
        </div>
