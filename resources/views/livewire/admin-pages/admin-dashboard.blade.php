<div  class=" w-full h-full flex flex-col " >
    ...
    <span class="flex pl-4 font-medium lg:text-sm text-gray-300 mb-4 xs:text-xs">Welcome Admin, {{ \Illuminate\Support\Facades\DB::table('users')->where('id', auth()->user()->id)->where('role', 'admin')->value('firstname') }} </span>
