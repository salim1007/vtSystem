<div class="flex flex-col w-full text-sm h-full overflow-y-auto scrollbar-hidden" style="height: 100vh">
    <div class="flex p-4 pl-4 items-center justify-between bg-gray-300 w-full">
        <span class="flex font-bold">Mailbox</span>
    ...
    <div class="flex h-full bg-gray-200 flex-col">
        <div class="flex flex-col">
            <span class="flex flex-col p-2 pl-4 shadow-lg font-medium italic bg-gray-200">Some response from the system users</span>
